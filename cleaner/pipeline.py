...
class CleanerPipeline:
    def __init__(self, input_dir, out_dir, min_conf, face_scale, ref_image=None, thresholds=None):
    ...
    def run(self):
        aligner = FaceAligner(min_conf=self.min_conf, face_scale=self.face_scale)
